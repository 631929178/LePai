...
import com.qianfeng.hyh.bean.HeaderPreBean2;
...
public class PreHeaderFragmnet2 extends Fragment {
    ImageView imageView;
    TextView textView;
    Handler handler;
    String URL_STRING="http://api.fengniao.com/app_ipad//focus_pic.php?appImei=000000000000000&osType=Android&osVersion=4.1.1&mid=19929 HTTP/1.1";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_pre_header_fragmnet2,null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        imageView= (ImageView) view.findViewById(R.id.headerPre2ImageId);
        textView= (TextView) view.findViewById(R.id.headerPre2TextId);
