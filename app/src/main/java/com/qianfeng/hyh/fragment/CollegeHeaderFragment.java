...
public class CollegeHeaderFragment extends Fragment {
    ImageView imageView;
    TextView textView;
    Handler handler;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        handler=new Handler();
        Log.d("hyh","学院头部视图onCreateView===========");
        return inflater.inflate(R.layout.fragment_college_header,null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        imageView= (ImageView) view.findViewById(R.id.headerCollege1ImageId);
        textView= (TextView) view.findViewById(R.id.headerCollege1TextId);
