...
public class Fragmentrenxiang extends Fragment {
    PullToRefreshGridView gridView;
    Handler handler;
    List<PorTraitBean.ListBean> dataList;
    final  String URL_STRING="http://api.fengniao.com/app_ipad/pic_bbs_list_v2.php?appImei=000000000000000&osType=Android&osVersion=4.1.1&fid=101&page=";
    int page=1;
    PorTraitGridAdpter adpter;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_fragmentrenxiang,null);
        gridView= (PullToRefreshGridView) view.findViewById(R.id.porTraitGridViewId);
        handler=new Handler();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        adpter=new PorTraitGridAdpter(getActivity(),dataList);
