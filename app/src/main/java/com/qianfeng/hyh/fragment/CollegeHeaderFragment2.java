...
public class CollegeHeaderFragment2 extends Fragment {
    ImageView imageView;
    TextView textView;
    Handler handler;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_college_header_fragment2,null);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        imageView= (ImageView) view.findViewById(R.id.headerCollege2ImageId);
        textView= (TextView) view.findViewById(R.id.headerCollege2TextId);
