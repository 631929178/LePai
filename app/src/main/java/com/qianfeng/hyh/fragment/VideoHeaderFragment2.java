...
public class VideoHeaderFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        handler=new Handler();
        return inflater.inflate(R.layout.fragment_video_header_fragment2,null);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        imageView= (ImageView) view.findViewById(R.id.headerVideo2ImageId);
        textView= (TextView) view.findViewById(R.id.headerVideo2TextId);
