...
public class PreHeaderFragment1 extends Fragment {
    ImageView imageView;
    TextView textView;
    Handler handler;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        handler=new Handler();
        return  inflater.inflate(R.layout.fragment_pre_header_fragment1,null);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        imageView= (ImageView) view.findViewById(R.id.headerPre1ImageId);
        textView= (TextView) view.findViewById(R.id.headerPre1TextId);
