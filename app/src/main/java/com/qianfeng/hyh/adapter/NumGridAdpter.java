 ...
 */
public class NumGridAdpter extends BaseAdapter {

    Context context;
    List<PorTraitBean.ListBean> list;

    public NumGridAdpter(Context context, List<PorTraitBean.ListBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView= LayoutInflater.from(context).inflate(R.layout.item_numgridview,null);
            viewHolder=new ViewHolder();
            viewHolder.imageView= (ImageView) convertView.findViewById(R.id.numimage1Id);
            viewHolder.textView= (TextView) convertView.findViewById(R.id.numtext1Id);
