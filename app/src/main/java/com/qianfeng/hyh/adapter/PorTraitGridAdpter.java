 ...
 */
public class PorTraitGridAdpter extends BaseAdapter {

    Context context;
    List<PorTraitBean.ListBean> list;

    public PorTraitGridAdpter(Context context, List<PorTraitBean.ListBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Log.d("hyh","我进到人像的getView==================");
        ViewHolder viewHolder=null;
        if (convertView==null){
            convertView= LayoutInflater.from(context).inflate(R.layout.item_portraitgird,null);
            viewHolder=new ViewHolder();
            viewHolder.imageView= (ImageView) convertView.findViewById(R.id.porTraitimage1Id);
            viewHolder.textView= (TextView) convertView.findViewById(R.id.porTraittext1Id);
