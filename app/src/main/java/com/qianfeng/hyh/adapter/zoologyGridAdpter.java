 ...
 */
public class zoologyGridAdpter extends BaseAdapter {


    Context context;
    List<PorTraitBean.ListBean> list;

    public zoologyGridAdpter(Context context, List<PorTraitBean.ListBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView= LayoutInflater.from(context).inflate(R.layout.zoologygridview,null);
            viewHolder=new ViewHolder();
            viewHolder.imageView= (ImageView) convertView.findViewById(R.id.zoologyimage1Id);
            viewHolder.textView= (TextView) convertView.findViewById(R.id.zoologytext1Id);
